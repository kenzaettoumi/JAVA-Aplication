...
public class LoginM extends JFrame {
	...
	public LoginM() {
		...
		label.setIcon(new ImageIcon(LoginM.class.getResource("/images/The-First-Few-Weeks-Of-University-Life.jpg")));
		panel.add(label);
		        ...
		        try {
                    ...
                    {	if(rs2.getInt(9)==1){JOptionPane.showMessageDialog(panel,"C'est un admin") ;
                    	...
                    	if(rs2.getInt(6)==0){
                        		...
                        		String cin=rs2.getString(1);
                        		String cne=rs2.getString(3);
